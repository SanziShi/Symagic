...
public class GMailCaptchaEngine extends ListImageCaptchaEngine {
	...
	public static final Integer WORD_MAX_LENGTH = new Integer(6);

	public static final Integer IMAGE_WIDTH = new Integer(125);
	public static final Integer IMAGE_HEIGHT = new Integer(30);

	public static final Integer FONT_MIN_SIZE = new Integer(15);
	public static final Integer FONT_MAX_SIZE = new Integer(20);

	@Override
	protected void buildInitialFactories() {

		WordGenerator wordGenerator = (new RandomWordGenerator(
				"23456789ABCDEFGHJKMNPQRSTUVWXY"));

		BackgroundGenerator backgroundGenerator = new UniColorBackgroundGenerator(
				IMAGE_WIDTH, IMAGE_HEIGHT);

		Font[] fontsList = new Font[] { Font.decode("Arial"),
				Font.decode("Georgia"), Font.decode("Verdana"),
				Font.decode("Courier New") };
		FontGenerator fontGenerator = new RandomFontGenerator(FONT_MIN_SIZE,
				FONT_MAX_SIZE, fontsList);

		RandomRangeColorGenerator cgen = new RandomRangeColorGenerator(
				new int[] { 0, 128 }, new int[] { 0, 128 },
				new int[] { 0, 196 });

		TextDecorator[] textdecorators = new TextDecorator[] { new BaffleTextDecorator(
				new Integer(1), Color.WHITE) };

		TextPaster textPaster = new DecoratedRandomTextPaster(WORD_MIN_LENGTH,
				WORD_MAX_LENGTH, cgen, textdecorators);
