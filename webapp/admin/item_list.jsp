...
<script src="js/checkform.js" type="text/javascript" language="javascript"></script>
	...
	<div id="main">
		<div id="search2">
			<div id="searchleft">
				...
				网站路径：<a href="category_list.html">商品管理</a>&gt;
			</div>
            ...
            <div id="" style="float:right" >
			  ...
			  <input type="button" name="Submit" value="搜索" id="searchbutton" onClick="javascript:window.open('item_search_list.html','_parent','')">
               ...
               <a href="#2"><img  src="image/item_list.png"/></a>
               <a href="#3"><img onclick="expanse(document.getElementById('search_banner'));"  	src="image/item_search.png" /></a>
               </div>
        ...
        <div  class="user_note">
        <a name="3"></a>
        <div id="doublehead1"><strong>高级搜索</strong>
         <a id="header_right" href="#0"><input type="button" value="返回顶部"/></a>
        </div>
            ...
            <form action="item_manager" method="post">
				...
				<tr>
				 ...
				 <tr>
					...
					<th>版&nbsp;&nbsp;&nbsp;次：</th>
            		<td>
						<select name="version" class="midselect">
              				<option>全部版次</option>
             				<option>1</option>
              				<option>2</option>
              				<option>3</option>
				 ...
				 <tr>
				 <th></th>
				 	<td id="button_right"><input type="submit" name="button2" value="搜索"<!-- onClick="javascript:window.location.href='item_search_list.html'"-->>
				 </tr>
        </table>	
        </form>
		...
		<div id="double1">
			<div id="doublehead1"><strong>商品列表</strong>
             <a id="header_right" href="#0"><input type="button" value="返回顶部"/></a>
            </div>
			...
			<form action="" method="post" enctype="multipart/form-data" name="form1">
				...
				<td width="7%" rowspan="1" align="center"><span class="red"><s:property value="#st.index"/></span></td>
                <td class="checkBoxWidth" align="center"><input type="checkbox" value="<s:property value = '#bookItems.itemID'/>" /></td>
            <td width="16%" rowspan="1" align="right" class="inputHeader">
            <a href="item_info.html"><img src="../<s:property value = '#bookItems.picturePath'/>" alt="<s:property value = '#bookItems.name'/>" id="img_format"></a>
            </td>
			<td width="77%" align="left" class="inputHeader"><span class="red" id="item_font20"><s:property value = "#bookItems.name"/></span></font><br /><font id="item_font17">作者：<s:property value = "#bookItems.author"/>&nbsp; &nbsp; </font><br />
            <font id="item_font17">出版社：<s:property value = "#bookItems.publisher"/>&nbsp; &nbsp;出版时间：<s:property value = "#bookItems.publishTime"/></font>&nbsp; <br />
            <font id="item_font17"> 市场价:<s:property value = "#bookItems.marketPrice"/>&nbsp;</font><font id="item_font17" class="font_right">商城价：<s:property value = "#bookItems.price"/></font>
            </td>
            <td align="left" class="inputHeader">
            <a href="item_modify?itemID=<s:property value = '#bookItems.itemID'/>"><input type="button"  value="修改"/></a>&nbsp;&nbsp;
            <a>
            <input type="button" onclick="ajax_item_off(this,"<s:property value = "#bookItems.itemID"/>")" value="下架"/></a>&nbsp;&nbsp;
		    <a onclick="ajax_delete_tag("<s:property value = "#bookItems.itemID"/>")" ><input type="button"  value="删除"/></a>&nbsp;&nbsp;
            </td>
            	</tr>
                </s:iterator>
            </table>
...
<!--        <a href="item_list_refresh.html" style="display:none" onClick="javascript:if(window.confirm('确定删除？')) window.location.href='item_list_refresh.html';else return false;"><img src="../image/bt_delete.gif" alt="删除" width="37" height="19" border="0"></a>-->
      <!--  </td>
		...
		<input type="button" value="删除"/>&nbsp;&nbsp;
			...
			<a name="1"></a>
			<div id="double2">
			<div id="doublehead2"><strong>添加商品</strong> 
            <a id="header_right" href="#0"><input type="button" value="返回顶部"/></a>
            </div>
            ...
            <form action="item_add_submit" method="post">
				<table id="itemsearch">
				   <tr>
            		...
            		<td width="390">
					 <input type="text" class="inputttextlarge" name="name" onFocus="nextfield='name'"  maxlength="25"></td>
				 ...
				 <th>出版社：</th>
                  ...
                  <tr>
				 <th>出版时间：</th>
					<td><input type="text" name="publishTime"  value=""></td>
					<td>#选填项</td>
          		 </tr>
                 <tr>
				 <th>ISBN：</th>
                 ...
                 <th>版次：</th>
					<td><input type="text" name="edition" class="smallinputext" value=""></td>
					<td>#选填项</td>
                    
          		 </tr>
                  </tr>
                 <th>开本：</th>
					<td><input type="text" name="format" class="smallinputext" value=""></td>
					<td>#选填项</td>
				 ...
				 <th>装帧：</th>
                  ...
                  <tr>
				 <th>分类标签：</th>
					<td><input type="text" name="bookClassify"size="12" value=""></td>
					<td>#选填项，可多个</td>
          		 </tr>
				 <th>市场价：</th>
				 ...
				 <th>折扣：</th>
				 <td>
				 <input type="text" name="discount" class="smallinputext" value="">				 </td>
				  <td><span class="red">*必填项</span></td>
				 </tr>
				 <tr>
				 <th>库存量：</th>
				 <td>
				 <input type="text" name="inventory" class="smallinputext" value="">				 </td>
				 <td><span class="red">*必填项</span></td>
				
				 <tr>
				 <th></th>
			 	  <td>
				 <input type="button" name="button2" value="添加" onClick="checkitemform()">
